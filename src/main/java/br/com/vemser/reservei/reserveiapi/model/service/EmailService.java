...
//            ClassPathResource image = new ClassPathResource("src/main/resources/templates/images/img1.png");
            FileSystemResource image1 = new FileSystemResource(new File("resources\\templates\\img1.png"));
            FileSystemResource image2 = new FileSystemResource(new File("resources\\templates\\img2.png"));
            FileSystemResource image3 = new FileSystemResource(new File("resources\\templates\\Reservei.png"));
